...
This repo is NOT the official ZMK configuration of the MoErgo Glove80 wireless split contoured keyboard (go [here](https://github.com/moergo-sc/glove80-zmk-config)) .
